                ...
                VStack {
                    GeometryReader { geometry in
                        ...
                        ZStack {
                            ...
                            lessonNavigationLink(label: "L3", color: .yellow, destination: Lesson3())
                                .position(x: centerX + radius, y: centerY)
                            lessonNavigationLink(label: "L4", color: .green, destination: Lesson4())
                                .position(x: centerX + radius * cos(.pi / 4), y: centerY + radius * sin(.pi / 4))
                            lessonNavigationLink(label: "L5", color: .cyan, destination: Lesson5())
                                .position(x: centerX, y: centerY + radius)
                            lessonNavigationLink(label: "L6", color: .blue, destination: Lesson6())
                                .position(x: centerX - radius * cos(.pi / 4), y: centerY + radius * sin(.pi / 4))
                            lessonNavigationLink(label: "L7", color: .indigo, destination: Lesson7())
                                .position(x: centerX - radius, y: centerY)
